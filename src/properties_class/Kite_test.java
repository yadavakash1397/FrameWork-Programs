...
public class Kite_test extends Base_class
{
	...
	{	
		TCID=200;
		String exp=Utility_class.getExcelTD(3, 6)+"ak";
	...
	@AfterMethod
	public void logout(ITestResult result) throws EncryptedDocumentException, IOException
	{
		System.out.println("act status"+result.getStatus());
		System.out.println("failure int "+result.FAILURE);
